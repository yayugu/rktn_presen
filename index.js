...
(function() {
  var biggerRatio, dispatchPage, dispatchPageImg, drawTextWithCanvas, isPageCode, maxSizeWhenKeepAspectRatio, scaleCtx, setFont, taplog;
  ...
  biggerRatio = function(width, height, ratioX, ratioY) {
    var ratio2X, ratio2Y;
  ...
  maxSizeWhenKeepAspectRatio = function(width, height, ratioX, ratioY) {
    var _biggerRatio;
  ...
  drawTextWithCanvas = function(elem, options) {
    ...
    fontSize = options.fontSize || 80 * 2;
    font = options.font || "HelveticaNeue-Light, GothicMB101Pro-Light";
  ...
  $(function() {
    var SL, SR, SV, count, current, height, i, m, mousewheel, next, prev, root, size, slides, width;
    next = function() {
    ...
    slides = _(slides).map(function(text) {
      var s;
      s = $("<div>").attr("class", SR).attr('width', size.width);
      s[0].innerHTML = text;
      root.append(s);
      return s[0];
    });
